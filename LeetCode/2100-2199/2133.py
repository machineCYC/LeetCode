'''
2133. Check if Every Row and Column Contains All Numb

2022.01.09 Sunday 14:06
'''
...
if __name__ == "__main__":
    obj = Solution()
    assert obj.checkValid(matrix = [[1,2,3],[3,1,2],[2,3,1]]) == True
    assert obj.checkValid(matrix = [[1,1,1],[1,2,3],[1,2,3]]) == False
    assert obj.checkValid(matrix = [
